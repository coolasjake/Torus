...
public class MissionType : ScriptableObject
{
    ...
    public class WaveData
    {
        ...
        public bool[] allowedMainTypes = new bool[Enum.GetNames(typeof(EnemyClass)).Length];
        ...
        //[EnumNamedArray(typeof(EnemyClass))]
        public bool[] allowedRareTypes = new bool[Enum.GetNames(typeof(EnemyClass)).Length];
